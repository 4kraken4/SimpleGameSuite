...
public class ImcGraphPanel extends javax.swing.JPanel {
    ...
    public GameWin getWin() {
        return imcGraphView2.getWin();
    }

    public void setWin(GameWin win) {
        this.imcGraphView2.setWin(win);
    }
...
//            imcGraphView2.setPathHighlighted(!gameBoard1.isPathHighlighted());
    ...
    private void initComponents() {
        ...
        imcGraphView2 = new games.IMC.view.ImcGraphView();
        ...
        imcGraphView2.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        jPanel7.add(imcGraphView2, java.awt.BorderLayout.CENTER);
    ...
    private games.IMC.view.ImcGraphView imcGraphView2;
